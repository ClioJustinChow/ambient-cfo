      ...
      {open ? (
        <>
          ...
          >
            ...
            <Tabs value={tab} onValueChange={setTab} className="flex min-h-0 flex-1 flex-col gap-0 px-4 pt-3">
              ...
              <TabsContent
                value="chat"
                className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden pb-4"
              >
                ...
                <div className="min-h-0 flex-1 space-y-4 overflow-y-auto rounded-xl border border-gray-100 bg-gray-50/50 p-3 custom-scrollbar">
                  {chatHistory.length === 0 ? (
                    <p className="py-8 text-center text-sm text-gray-500">
                      Ask Ambient CFO anything — messages appear here.
                    </p>
                  ) : (
                        ...
                        <div
                          className={cn(
                            ...
                            msg.role === 'user'
                              ...
                              : 'rounded-bl-[4px] border border-gray-200 bg-white text-gray-800',
                          )}
                        >
                          {msg.role === 'ai' &&
                ...
                <div className="flex gap-2 border-t border-gray-100 pt-3">
                  <input
                    ...
                    placeholder="Message Ambient CFO…"
