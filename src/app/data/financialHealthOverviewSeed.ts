...
export const FHO_UNBILLED_MATTER_ROWS: FhoUnbilledMatterRow[] = [
  { id: 'u1', matter: 'Acme Corp — IP dispute', amount: '$22,100', ageLabel: '120+ days WIP', rank: 1 },
  { id: 'u2', matter: 'Harbor LLC — contract review', amount: '$18,400', ageLabel: '90+ days WIP', rank: 2 },
  { id: 'u3', matter: 'Summit RE — closing', amount: '$12,000', ageLabel: '75 days WIP', rank: 3 },
  { id: 'u4', matter: 'Northline — employment', amount: '$9,200', ageLabel: '45 days WIP', rank: 4 },
  { id: 'u5', matter: 'Metro Transit — discovery', amount: '$6,850', ageLabel: 'Ready to pre-bill', rank: 5 },
];
