...
export const migrationMetrics: MigrationMetric[] = [
  { id: 'm1', label: '34,279 of 34,520 Transactions Mapped', pctLabel: '99.2%' },
...
export const unbilledTimeCard = {
  ...
  topMatters: [
    { name: 'Acme Corp — IP dispute', amount: '$22,100' },
    { name: 'Harbor LLC — contract review', amount: '$18,400' },
    { name: 'Summit RE — closing', amount: '$12,000' },
  ] as AgedMatterRow[],
};
